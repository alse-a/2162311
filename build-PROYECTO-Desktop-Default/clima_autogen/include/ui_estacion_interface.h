...
"border-top-color: rgb(136, 138, 133);"));
        ...
        txt_latitud->setCursor(QCursor(Qt::ArrowCursor));
        ...
        label_8->setGeometry(QRect(100, 0, 121, 17));
    ...
    void retranslateUi(QMainWindow *Estacion_interface)
    {
        ...
        label_8->setText(QApplication::translate("Estacion_interface", "Estaci\303\263n : EB1ECI", Q_NULLPTR));
    } // retranslateUi
